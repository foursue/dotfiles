let s:coding_styles = {}
let s:coding_styles['My']     = 'set expandtab   tabstop=4 shiftwidth=4 softtabstop&'
let s:coding_styles['Hanjo']  = 'set noexpandtab tabstop=4 shiftwidth=4 softtabstop&'
let s:coding_styles['Short']  = 'set expandtab   tabstop=2 shiftwidth=2 softtabstop&'
